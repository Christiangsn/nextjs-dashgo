            ...
            <Flex align="center" ml="auto">
                ...
                <Flex align="center">
                    <Box mr="4" textAlign="right">
                        <Text>Christian Guimaraes</Text>
                        <Text color="gray.300" fontSize="small">christianguimaraes1996@gmail.com</Text>
                    </Box>
                    <Avatar size="md" name="Christian Guimaraes" src="https://github.com/christiangsn.png"/>
                </Flex>
            </Flex>
        </Flex>
    )
